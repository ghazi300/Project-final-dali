...
@Component({
  selector: 'app-sessionFront',
  templateUrl: './sessionFront.component.html',
  styleUrls: ['./sessionFront.component.css']
})
export class SessionFrontComponent implements OnInit {
  ...
  accessSession(sessionId: number): void {
    this.router.navigate(['/sessiondetailFront', sessionId]);
