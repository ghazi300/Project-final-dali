...
import { CompletedSessionDetails } from 'src/app/BackOffice/back-all/Models/completed-session-details.model';
...
@Component({
    selector: 'app-completed-session-detailsFront',
    templateUrl: './completed-session-detailsFront.component.html',
    styleUrls: ['./completed-session-detailsFront.component.css']
})
export class CompletedSessionDetailsFrontComponent implements OnInit {
